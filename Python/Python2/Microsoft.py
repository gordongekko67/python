...
df = pd.read_csv("/Users/Enrico/Downloads/microsoft-malware-prediction/train.csv", nrows = 100)
dl = pd.read_csv("/Users/Enrico/Downloads/microsoft-malware-prediction/test.csv" , nrows = 100)
